...
- **PcapPlusPlus**:
  ...
  - **Windows**: 需要安装 Npcap SDK 及 WinPcap/Npcap 驱动，并在 CMake 中配置 PcapPlusPlus 路径。
    从 https://npcap.com/#download 上下载Npcap installer，安装选择如下图所示:
  - ![img.png](img.png)
...
# 配置并构建
cmake -B build -DCMAKE_BUILD_TYPE=Release -DCMAKE_PREFIX_PATH=D:/opt/Qt/Qt6.6.2/6.6.2/gcc_64
